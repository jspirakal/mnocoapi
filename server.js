...
const colum=[
    {table_id:'user',label:'U_id',value:'u_id'},
    {table_id:'user',label:'U_username',value:'u_username'},
    {table_id:'teacher',label:'T_id',value:'t_id'},
    {table_id:'teacher',label:'T_username',value:'t_username'}
];
app.use(cors());
